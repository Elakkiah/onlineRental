<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="confirm.aspx.cs" Inherits="online_rental1.confirm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <form id="form1" runat="server">
  <h1 style="font-size: xx-large; text-align: center">&nbsp;</h1>
    <h1 style="font-size: xx-large; text-align: center"><b>Confirm Booking</b></h1>
     ...
     <div id="templatemo_section_1_2">
        ...
        &nbsp;<table style="width: 100%; height: 380px;">
             <tr style="font-family: Arial; font-size: large">
                <td style="font-size: large; color: #FFFFFF"><b>Book ID :</b></td>
								 ...
								 <p>
             <asp:Button ID="Button1" runat="server" Height="55px" OnClick="Button1_Click" style="background-color: #009900; color: #FFFFFF;" Text="Confirm Booking" Width="146px" />
             <asp:Button ID="Button2" runat="server" Height="53px" OnClick="Button2_Click" style="background-color: #FF0000; color: #FFFFFF;" Text="Cancel" Width="140px" />
         </p>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="online_rental1.Login" %>
 ...
 <center>
    <div id="templatemo_content_panel_1" style="width: 593px; height: 617px">
     ...
     <div id="templatemo_section_1_2" style="text-align: center">
        ...
        &nbsp;<br />
         <span style="font-family: Arial; font-weight: bold; font-size: xx-large">USER LOGIN HERE</span><br />
         <br />
         <br />
